...
<table>
  ...
  <tbody>
    <tr>
      ...
      <th>
        <ul>
          ...
          <li><a  style="text-decoration:none">Polynomial Regression</a></li>
          <li><a  style="text-decoration:none">Logistic Regression</a></li>
          <li><a  style="text-decoration:none">Naive Bayes</a></li>
        </ul>
      </th>
      <th> 
        <ul>
          ...
          <li><a  style="text-decoration:none">Random Forest</a></li>
    ...
    <tr>
      ...
      <th>
        <ul>
          <li><a  style="text-decoration:none">K-Means</a></li>
    ...
    <tr>
      ...
      <th>
        <ul>
          <li><a  style="text-decoration:none">Principle Component Analysis (PCA)</a></li>
    ...
    <tr>
      ...
      <th>
        <ul>
          ...
          <li><a  style="text-decoration:none">Boosting</a></li>
      </th>
      <th>
        <ul>
    ...
    <tr>
      ...
      <th>
        <ul>
          ...
          <li><a  style="text-decoration:none">Recurrent Neural Networks (ANN)</a></li>
...
- <a href="/dsandml/dataengineering/index.qmd" style="text-decoration:none" target="_blank">How do we treat the categorical features for our data science project?</a>
- <a href="/dsandml/datacollection/index.qmd" style="text-decoration:none" target="_blank">Data collection through Webscraping</a>
