...
## **$\text{\textcolor{#782F40}{Data Science}}$**  
...
## **$\text{\textcolor{#782F40}{Machine Learning Algorithms}}$**  
...
- [Support Vector Machine (SVM)](/dsandml/svm/index.qmd){target="_blank" style="text-decoration:none"}
:::
::::  
...
## **$\text{\textcolor{#782F40}{Deep Learnings}}$**  
...
## **$\text{\textcolor{#782F40}{Model Evaluation and Fine Tuning}}$**  
