...
## Course Projects  
- [Option pricing techniques: A performance-based comparative study of the randomized quasi-Monte Carlo method and Fourier cosine method](https://www.academia.edu/103433771/Option_pricing_techniques_A_performance_based_comparative_study_of_the_randomized_quasi_Monte_Carlo_method_and_Fourier_cosine_method){:target="_blank"}  
  Advisor: [Prof. Giray Ökten](https://www.math.fsu.edu/~okten/){:target="_blank"}  
...
- [The Relationship Between Forced Sexual Activities And Suicidal Attempts Of The Victims](https://www.academia.edu/37973800/The_Relationship_Between_Forced_Sexual_Activities_And_Suicidal_Attempts_Of_The_Victims){:target="_blank"}    
  Advisor: [Dr. Andy Chang](https://ysu.edu/people/andy-chang){:target="_blank"}  
...
- [Study of Runge-Kutta Method of Higher orders and its Applications](https://www.academia.edu/13322836/Study_of_Runge_Kutta_Method_of_Higher_orders_and_its_Applications){:target="_blank"}  
  Advisor: [Dr. Md. Abdus Samad](http://appliedmath.du.ac.bd/details-ofdr-md-abdus-samad/){:target="_blank"}  
